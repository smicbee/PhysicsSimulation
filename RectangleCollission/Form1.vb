...
Public Class Form1
    ...
    Dim objectcounterid As Integer = -1
    ...
    Class CompositeObjekt
        ...
        Public Sub Load()
            For Each singleobj In singles
                Form1.collisionobjects.Add(singleobj)
            Next
        End Sub
    ...
    Public Function collideswithwall_x(obj As RecObj)
        ...
        If obj.position.Right > Me.Width Then
            obj.position.X = Me.Width - obj.position.Width
            Return True
        End If
    ...
    Public Function collideswithwall_y(obj As RecObj)
        ...
        If obj.position.Bottom > Me.Height Then
            obj.position.Y = Me.Height - obj.position.Height
            Return True
        End If
    ...
    Sub render_next_frame(sender As Object, e As DoWorkEventArgs)
        Dim outrender As New Bitmap(Me.Width, Me.Height)
    ...
    Sub add_new_obj()
        Dim pos As New Rectangle(Rnd() * Me.Width, Rnd() * Me.Height, 20, 20)
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        AddHandler t.Tick, AddressOf add_new_obj
        t.Interval = 500
        't.Start()
        ...
        'Dim menschobj As CompositeObjekt = Mensch(New Point(100, 100))
        'menschobj.Load()

        'Dim bh As CompositeObjekt = Blackhole(New Point(350, 250))
        'bh.Load()


        spawn_random_objs_christmas(5)


        'dreikörperproblem()


        'spawn_random_objs(20)
    ...
    Sub spawn_random_objs_christmas(num As Integer)
        ...
        For i = 0 To num
retry:
            Dim pos As New Rectangle(Rnd() * Me.Width, Rnd() * Me.Height, Rnd() * 200 + 20, Rnd() * 200 + 20)

            Dim c As CompositeObjekt = ChristmasGIF(New Point(Rnd() * Me.Width, Rnd() * Me.Height), 0.2)
